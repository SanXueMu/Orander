...
export const THEME_OPTIONS: ThemeOption[] = [
  {
    id: 'amber',
    name: '米脂白',
    description: '米脂白底配春茶绿，茶汤金点缀的家常餐桌。',
    navColor: '#FFFFFF',
    navBackground: '#1F5B43',
    swatch: ['#F5F1E6', '#1F5B43', '#C9A24F'],
  },
  {
    id: 'olive',
    name: '春茶绿',
    description: '青绿茶园的清晨，绿意更浓的清新一桌。',
    navColor: '#FFFFFF',
    navBackground: '#1F5B43',
    swatch: ['#EDF2EC', '#1F5B43', '#A8842F'],
  },
  {
    id: 'ink',
    name: '夜幕茶褐',
    description: '夜幕落下，墨绿衬着茶汤金的暖光。',
    navColor: '#F0EDE4',
    navBackground: '#171C19',
    swatch: ['#1C221E', '#D9BE7A', '#6FA98C'],
  },
]
