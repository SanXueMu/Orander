...
export const THEME_OPTIONS: ThemeOption[] = [
  {
    id: 'amber',
    name: '喜茶白',
    description: '纯白底配喜茶绿，价格一抹红，干净直接。',
    navColor: '#FFFFFF',
    navBackground: '#2DCC70',
    swatch: ['#FFFFFF', '#2DCC70', '#FF4D4F'],
  },
  {
    id: 'olive',
    name: '清新绿',
    description: '浅绿底上的喜茶绿，清新加倍。',
    navColor: '#FFFFFF',
    navBackground: '#2DCC70',
    swatch: ['#F0F9F1', '#2DCC70', '#FF6600'],
  },
  {
    id: 'ink',
    name: '夜间黑',
    description: '夜色黑底，喜茶绿更亮眼。',
    navColor: '#F0F0F0',
    navBackground: '#141414',
    swatch: ['#141414', '#2DCC70', '#FFA940'],
  },
]
